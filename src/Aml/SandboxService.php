...
class SandboxService
{
    ...
    /**
     * @param SandboxProfile $amlProfile
     *
     * @return SandboxResult
     *
     * @throws SandboxAmlException
     */
    public function performCheck(SandboxProfile $amlProfile): SandboxResult
    {
        ...
        return new SandboxResult(Json::decode((string)$response->getBody()), $response);
    }
    ...
    private function validateAmlResult(ResponseInterface $response): void
    {
        ...
        throw new SandboxAmlException($this->getErrorMessage($response), $response);
    }
